...
$MESS ["REPLACE_TOP_WITH_PARENT"] = 'Заменить все JS-вызовы вида "top.bx..." на "parent.bx..."';
$MESS ["REPLACE_TOP_WITH_PARENT_HELP"] = "Отметьте галочку выше, если с отображаемым топбаром Giftd у вас некорректно работает какой-либо функционал.";
