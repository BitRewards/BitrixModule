...
$MESS ['COMPONENT_VIEW_SETTINGS'] = "Компонент валицации купонов";
$MESS ["COMPONENT_IS_ACTIVE"] = "Использовать компонент";
$MESS ["COMPONENT_TEMPLATE"] = "Шаблон компонента";
$MESS ["COMPONENT_TEMPLATE_JS_COUPON_FIELD_ID"] = "Привязка к полю ввода купонов по ID";
$MESS ["COMPONENT_TEMPLATE_JS_CALLBACK"] = "Функция-обработчик события проверки купона (javascript)";

$MESS ['JS_PANEL_SETTINGS'] = "Окно Giftd";
